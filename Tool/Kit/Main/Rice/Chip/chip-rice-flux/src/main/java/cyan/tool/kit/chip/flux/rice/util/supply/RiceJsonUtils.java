...
import cyan.tool.kit.chip.flux.rice.flux.RiceJsonFluxes;
...
public class RiceJsonUtils {
    ...
    public static <T> String parserJson(T target) {
        try {
            return RiceJsonFluxes.parserJson(target);
    ...
    public static <T> T parserBean(String json, Class<T> clazz) {
        try {
            return RiceJsonFluxes.parserBean(json, clazz);
    ...
    public static <T> List<T> parserList(String json, CollectionType listType) {
        try {
            return RiceJsonFluxes.parserList(json,listType);
    ...
    public static <Z extends List,T> List<T> parserList(String json, Class<Z> parserClazz, Class<T> clazz) {
        CollectionType listType = RiceJsonFluxes.MAPPER.getTypeFactory().constructCollectionType(parserClazz, clazz);
    ...
    public static <T> Set<T> parserSet(String json, CollectionType setType) {
        try {
            return RiceJsonFluxes.parserSet(json,setType);
    ...
    public static <Z extends Set,T> Set<T> parserSet(String json, Class<Z> parserClazz, Class<T> clazz) {
        CollectionType setType = RiceJsonFluxes.MAPPER.getTypeFactory().constructCollectionType(parserClazz, clazz);
    ...
    public static <T,K> Map<T, K> parserMap(String json, MapType mapType) {
        try {
            return RiceJsonFluxes.parserMap(json, mapType);
    ...
    public static <Z extends Map,T,K> Map<T, K> parserMap(String json, Class<Z> parserClazz, Class<T> keyClazz, Class<K> valueClazz) {
        MapType mapType = RiceJsonFluxes.MAPPER.getTypeFactory().constructMapType(parserClazz, keyClazz, valueClazz);
    ...
    public static <H extends List,Y extends Map,T,K> Map<T,List<K>> parserMapList(String json, Class<H> parserListClazz, Class<Y> parserMapClazz, Class<T> keyClazz, Class<K> valueClazz) {
        CollectionType collectionType = RiceJsonFluxes.MAPPER.getTypeFactory().constructCollectionType(parserListClazz, valueClazz);
        MapType mapType = RiceJsonFluxes.MAPPER.getTypeFactory().constructMapType(parserMapClazz, keyClazz, collectionType.getRawClass());
        return parserMap(json,mapType);
    }
    ...
    public static<H extends Map,Y extends Map,Z,T,K> Map<Z, Map<T, K>> parserMapMap(String json, Class<H> wrapMapClazz, Class<Y> contentMapClazz, Class<Z> wrapKeyClazz, Class<T> contentKeyClazz, Class<K> contentValueClazz) {
        MapType contentType = RiceJsonFluxes.MAPPER.getTypeFactory().constructMapType(contentMapClazz, contentKeyClazz,contentValueClazz);
        MapType mapType = RiceJsonFluxes.MAPPER.getTypeFactory().constructMapType(wrapMapClazz, wrapKeyClazz, contentType.getRawClass());
        return parserMap(json,mapType);
    }

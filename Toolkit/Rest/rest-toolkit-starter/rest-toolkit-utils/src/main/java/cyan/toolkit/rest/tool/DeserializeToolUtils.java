...
import cyan.toolkit.rest.error.supply.JsonDeserializeException;
import cyan.toolkit.rest.kit.DeserializeKitUtils;
 ...
 */
@Slf4j
public class DeserializeToolUtils {
    ...
    public static Map<String, Object> deserializerBean(JsonParser parser) {
        try {
            return DeserializeKitUtils.deserializerBean(parser);
    ...
    public static List<Object> deserializerList(JsonParser parser) {
        try {
            return DeserializeKitUtils.deserializerList(parser);
        } catch (JsonDeserializeException exception) {
    ...
    public static List<Map<String, Object>> deserializerBeanList(JsonParser parser) {
        try {
            return DeserializeKitUtils.deserializerBeanList(parser);
        } catch (JsonDeserializeException exception) {
    ...
    public static Map<String, Object> deserializerMap(JsonParser parser) {
        try {
            return DeserializeKitUtils.deserializerMap(parser);
        } catch (JsonDeserializeException exception) {
    ...
    public static Map<String,Map<String, Object>> deserializerBeanMap(JsonParser parser){
        try {
            return DeserializeKitUtils.deserializerBeanMap(parser);
        } catch (JsonDeserializeException exception) {

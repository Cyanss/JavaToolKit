...
import cyan.toolkit.rest.kit.JsonKitUtils;
...
public class JsonToolUtils {
    ...
    public static <T> String parserJson(T target) {
        try {
            return JsonKitUtils.parserJson(target);
    ...
    public static <T> T parserBean(String json, Class<T> clazz) {
        try {
            return JsonKitUtils.parserBean(json, clazz);
    ...
    public static <T> List<T> parserList(String json, CollectionType listType) {
        try {
            return JsonKitUtils.parserList(json,listType);
    ...
    public static <Z extends List,T> List<T> parserList(String json, Class<Z> parserClazz, Class<T> clazz) {
        CollectionType listType = JsonKitUtils.MAPPER.getTypeFactory().constructCollectionType(parserClazz, clazz);
    ...
    public static <T> Set<T> parserSet(String json, CollectionType setType) {
        try {
            return JsonKitUtils.parserSet(json,setType);
    ...
    public static <Z extends Set,T> Set<T> parserSet(String json, Class<Z> parserClazz, Class<T> clazz) {
        CollectionType setType = JsonKitUtils.MAPPER.getTypeFactory().constructCollectionType(parserClazz, clazz);
    ...
    public static <T,K> Map<T, K> parserMap(String json, MapType mapType) {
        try {
            return JsonKitUtils.parserMap(json, mapType);
    ...
    public static <T> T[] parserArray(String json, ArrayType arrayType) {
        try {
            return JsonKitUtils.parserArray(json, arrayType);
        } catch (JsonParseListException exception) {
            log.error("It is failed during json to parse as map of bean!",exception);
            exception.printStackTrace();
            return null;
    ...
    public static <Z extends List,T> T[] parserArray(String json, Class<T> clazz) {
        ArrayType arrayType = JsonKitUtils.MAPPER.getTypeFactory().constructArrayType(clazz);
    ...
    public static <Z extends Map,T,K> Map<T, K> parserMap(String json, Class<Z> parserClazz, Class<T> keyClazz, Class<K> valueClazz) {
        MapType mapType = JsonKitUtils.MAPPER.getTypeFactory().constructMapType(parserClazz, keyClazz, valueClazz);
    ...
    public static <H extends List,Y extends Map,T,K> Map<T,List<K>> parserMapList(String json, Class<H> parserListClazz, Class<Y> parserMapClazz, Class<T> keyClazz, Class<K> valueClazz) {
        CollectionType collectionType = JsonKitUtils.MAPPER.getTypeFactory().constructCollectionType(parserListClazz, valueClazz);
        MapType mapType = JsonKitUtils.MAPPER.getTypeFactory().constructMapType(parserMapClazz, keyClazz, collectionType.getRawClass());
        return parserMap(json,mapType);
    }
    ...
    public static <Z extends List, Y extends Map, T, K> List<Map<T, K>> parserListMap(String json, Class<Z> wrapKeyClazz, Class<Y> contentMapClazz, Class<T> contentKeyClazz, Class<K> contentValueClazz) {
        MapType contentType = JsonKitUtils.MAPPER.getTypeFactory().constructMapType(contentMapClazz, contentKeyClazz, contentValueClazz);
        CollectionType collectionType = JsonKitUtils.MAPPER.getTypeFactory().constructCollectionType(wrapKeyClazz, contentType.getRawClass());
    ...
    public static <T, K> List<Map<T, K>> parserListMap(String json, Class<T> contentKeyClazz, Class<K> contentValueClazz) {
        MapType contentType = JsonKitUtils.MAPPER.getTypeFactory().constructMapType(Map.class, contentKeyClazz, contentValueClazz);
        CollectionType collectionType = JsonKitUtils.MAPPER.getTypeFactory().constructCollectionType(List.class, contentType.getRawClass());
        return parserList(json, collectionType);
    }
    ...
    public static<H extends Map,Y extends Map,Z,T,K> Map<Z, Map<T, K>> parserMapMap(String json, Class<H> wrapMapClazz, Class<Y> contentMapClazz, Class<Z> wrapKeyClazz, Class<T> contentKeyClazz, Class<K> contentValueClazz) {
        MapType contentType = JsonKitUtils.MAPPER.getTypeFactory().constructMapType(contentMapClazz, contentKeyClazz,contentValueClazz);
        MapType mapType = JsonKitUtils.MAPPER.getTypeFactory().constructMapType(wrapMapClazz, wrapKeyClazz, contentType.getRawClass());
        return parserMap(json,mapType);
    }

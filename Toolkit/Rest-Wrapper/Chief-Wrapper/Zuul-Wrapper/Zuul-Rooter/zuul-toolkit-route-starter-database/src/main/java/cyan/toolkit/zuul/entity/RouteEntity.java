...
public class RouteEntity extends TimeEntity<Date> {
    ...
    public static RouteEntity toEntity(DynamicRoute route) {
        return new RouteEntity.Builder().name(route.getName())
                .path(route.getPath()).location(route.getLocation()).build();
    }

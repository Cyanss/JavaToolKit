...
@ConditionalOnProperty(name = {"cyan.toolkit.zuul.route.enable"}, matchIfMissing = true)
public class RouteAutoConfigure {
    ...
    @Bean
    @ConditionalOnProperty(name = {"cyan.toolkit.zuul.route.type"}, havingValue = "NACOS", matchIfMissing = true)

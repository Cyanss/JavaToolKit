 ...
 */
public class IdArrayUtils {

    @SuppressWarnings("unchecked")
    public static<I,M extends IdModel<I,M>> I id(M model, int index, I... idArray) {
        I id = null;
    ...
    @SuppressWarnings("unchecked")
    public static<I,M extends IdModel<I,M>> I id(List<M> models, int index, I... idArray) {
        I id = null;
    ...
    @SuppressWarnings("unchecked")
    public static <I,M extends IdModel<I,M>>  void idArray(List<M> models, int index, I... idArray) throws ClassUnknownException {
    ...
    @SuppressWarnings("unchecked")
    public static <I,M extends IdModel<I,M>> void idArray(M model, int index, I... idArray) throws ClassUnknownException {
        if (GeneralUtils.isNotEmpty(model)) {
            /** 将model的id反向关联 */
